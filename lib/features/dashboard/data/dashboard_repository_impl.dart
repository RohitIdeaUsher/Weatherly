...
import 'package:weatherly/util/uuid_token.dart';
...
class DashboardRepositoryImpl extends DashboardRepository {
  ...
  Future<WeatherModel?> getCurrentWeatherData(
    ...
    try {
      ...
      final response =
          await _dioClient.get(Endpoints.WEATHER, queryParameters: param);
  ...
  Future<List<ForecastModel>> getFiveDaysWeatherForecast(
    ...
    try {
      ...
      final response =
          await _dioClient.get(Endpoints.FORECAST, queryParameters: param);
      ...
      final fiveDayForecast = groupedByDay.entries.take(5).map((entry) {
      ...
      currentWeatherData =
          fiveDayForecast.map((e) => ForecastModel.fromJson(e)).toList();
    } catch (e) {
      log(e.toString());
      rethrow;
    }
...
//place api....................
  @override
  Future<List<Prediction>> placeApi({
    ...
    try {
      await _dioClient
        ...
        dataList = (data['predictions'] as List)
